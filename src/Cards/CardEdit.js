...
//create a component function that allows you to edit exisisting cards
function CardEdit() {
  ...
  //create a function that allows you to flip the cards
  ...
  //create a useHistory function that will allow you to go to the deck that is selected
