...
//create a component function that allows you study the decks that have been created 
function DeckStudy() {
  ...
  //create a useEffect hook that will only run if the deck is more than 2 cards and will update every time there is a change to card variables or deckId state
  useEffect(() => {
