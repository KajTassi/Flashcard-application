...
//create a component function that allows you to edit created decks
function DeckEdit() {
  ...
  //create a useEffect hook for the side eveft that will update everytime there is a change to the deckId
  useEffect(() => {
  ...
  //create a submithandle that updates inputed information, and then allows you to go back to the selected deck after
